...
def get_nonintersecting_rack(points_anchor_base, rect_prisms_base, rot_var=np.pi, trans_var=1, return_debug=False, rot_sample_method="axis_angle"):
    ...
    while not torch.all(success): # and tries < 10:
        points_anchor2_temp = random_transform_rack(points_anchor_base, rot_var=rot_var, trans_var=trans_var, rot_sample_method=rot_sample_method)
...
def get_random_rack_demo(points_gripper, points_action, points_anchor_base, rot_var=np.pi, trans_var=1, transform_base=True, return_debug=False, rot_sample_method="axis_angle"):
    ...
    points_anchor2, debug_temp = get_nonintersecting_rack(points_anchor_base, rect_prisms_base, rot_var=rot_var, trans_var=trans_var, return_debug=return_debug, rot_sample_method=rot_sample_method)
